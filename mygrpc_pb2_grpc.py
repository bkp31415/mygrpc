...
class UnaryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.unary_unary(
                ...
                request_serializer=mygrpc__pb2.Message.SerializeToString,
                response_deserializer=mygrpc__pb2.MessageResponse.FromString,
                )
...
def add_UnaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mygrpc__pb2.Message.FromString,
                    response_serializer=mygrpc__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class Unary(object):
    ...
    def GetServerResponse(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/unary.Unary/GetServerResponse',
            mygrpc__pb2.Message.SerializeToString,
            mygrpc__pb2.MessageResponse.FromString,
